...
public class HsfUtil {
     ...
     * @return
     */
    public static List<HsfInterfaceInfo> getHsfModelList(String jarPath) {
        ...
        List<HsfInterfaceInfo> hsfModelList = new ArrayList<>();
        xmlFilePathList.forEach(i -> {
            ...
            for (Element ele : eles) {
                HsfInterfaceInfo hsfModel = new HsfInterfaceInfo();
